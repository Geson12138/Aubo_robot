...
void Example_MoveL::movelToTargetPositionByRelative1()
{
    ...
    //直线运动到目标位置，其中目标位置是法兰盘中心在基坐标系下通过相对当前位置沿X轴偏移0.001m给出的
...
void Example_MoveL::movelToTargetPositionByRelative2()
{
    ...
    //直线运动到目标位置，其中目标位置是法兰盘中心在用户坐标系下通过相对当前位置沿X轴偏移0.001m给出的
...
void Example_MoveL::movelToTargetPositionByRelative3()
{
    ...
    //直线运动到目标位置，其中目标位置是工具末端在工具坐标系下通过相对当前位置沿X轴偏移0.001m给出的
...
void Example_MoveL::movelToTargetPositionByRelative4()
{
    ...
    //直线运动到目标位置，其中目标位置是工具末端在基坐标系下通过相对当前位置沿X轴偏移0.001m给出的
    robotService.robotMoveLineToTargetPositionByRelative(baseCoord, moveRelative, true);
}
...
void Example_MoveL::movelToTargetPositionByRelative5()
{
    ...
    //直线运动到目标位置，其中目标位置是工具末端在用户坐标系下通过相对当前位置沿X轴偏移0.001m给出的
    robotService.robotMoveLineToTargetPositionByRelative(userCoord, moveRelative, true);
}
